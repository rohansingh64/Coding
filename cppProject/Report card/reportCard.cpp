...
ofstream out("C:/Coding/cppProject/Report card/student.txt", ios::app);
if(!out){
...
ifstream in("C:/Coding/cppProject/Report card/student.txt");
if(!in){
...
out.close();
in.close();
remove("C:/Coding/cppProject/Report card/student.txt");
rename("C:/Coding/cppProject/Report card/student.txt Temp.txt", "C:/Coding/cppProject/Report card/student.txt");
}
